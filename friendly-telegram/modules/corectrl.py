...
class CoreMod(loader.Module):
    ...
    strings = {
        ...
        "Neep": (
            "🕶 <b>Congrats! You are Neep!</b>\n\n"
            "<b>NeepTG version: {}.{}.{}</b>\n"
            "<b>Branch: master</b>"
        ),
        "Neep_beta": (
            "🕶 <b>Congrats! You are Neep!</b>\n\n"
            "<b>NeepTG version: {}.{}.{}beta</b>\n"
            "<b>Branch: beta</b>\n\n"
    ...
    async def ftgvercmd(self, message: Message) -> None:
        ...
        if "beta" in branch:
            await utils.answer(message, self.strings("Neep_beta").format(*ver))
        elif "alpha" in branch:
            await utils.answer(message, self.strings("Neep_alpha").format(*ver))
        else:
            await utils.answer(message, self.strings("Neep").format(*ver))
